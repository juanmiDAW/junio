        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('ordenadores.update', $ordenador) }}" class="max-w-sm mx-auto">
                ...
                <div class="mb-5">
                    ...
                    <x-text-input name="aula_id" type="text" id="aula_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        :value="old('aula_id', $ordenador->aula_id)" />
